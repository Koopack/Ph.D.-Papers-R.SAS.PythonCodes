...
cov_Rf_SPAD <- read.delim("Data/cov_Rf_SPAD.txt")
dim(cov_Rf_SPAD)
# [1] 23659     6
head(cov_Rf_SPAD,5)
cov_Rf <- cov_Rf_SPAD
setnames(cov_Rf_SPAD, old = c("Logp"), new = c("value"))
...
cov_Ds_SPAD <- read.delim("Data/cov_Ds_SPAD.txt")

dim(cov_Ds_SPAD)
# [1] 23734     4
head(cov_Ds_SPAD,5)
colnames(cov_Ds_SPAD)[4] <- "value"
head(cov_Ds_SPAD,5)
# Coverage for drought

circos.genomicTrack(data=cov_Ds_SPAD,panel.fun=function(start,value,...) {
...
Ds_SPAD_InterLink <- read.delim("Data/Ds_SPAD_InterLink.txt")

head(Ds_SPAD_InterLink,5)


Ds_SPAD_InterLink_3A <- subset(Ds_SPAD_InterLink, Chr=="3A"|Chr_2=="3A")

dim(Ds_SPAD_InterLink_3A)

nuc1_3A <- Ds_SPAD_InterLink_3A[, c(2,3,4)]
nuc2_3A <- Ds_SPAD_InterLink_3A[, c(6,7,8)]
...
Ds_SPAD_InterLink_3A_NOT3A <- subset(Ds_SPAD_InterLink, Chr!="3A" & Chr_2!="3A")

dim(Ds_SPAD_InterLink_3A_NOT3A) # 6 9 perfect like verified in exell


nuc1_NOT3A <- Ds_SPAD_InterLink[, c(2,3,4)]
nuc2_NOT3A <- Ds_SPAD_InterLink[, c(6,7,8)]
